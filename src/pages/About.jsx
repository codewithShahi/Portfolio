  ...
  return (
    <section id="about" className="text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="border border-white/20 rounded-lg p-6">
          ...
          <p className="text-white/50">
            ...
            modern technologies. My expertise lies in front-end development,
            allowing me to create seamless, end-to-end solutions.
          </p>
        ...
        <div className="border border-white/20 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 text-center gap-4">
            ...
            <div className="border border-white/20 rounded-lg p-3">
              <h4 className="text-emerald-300 font-medium mb-2">No Code Tools</h4>
              <ul className="text-white/50 space-y-1 text-sm">
                <li>Framer</li>
                <li>Webflow</li>
                <li>Figma</li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        {/* Skills Progress Bars + Approach */}
        <div className="border border-white/20 rounded-lg p-6">
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1">Tailwind CSS</label>
              <div className="w-full bg-white/10 rounded-full h-2">
                <div className="bg-emerald-300 h-2 rounded-full" style={{ width: "98%" }}></div>
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Bootstrap</label>
              <div className="w-full bg-white/10 rounded-full h-2">
        ...
        <div className="border border-white/20 rounded-lg p-6 flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="text-white/50">
              ...
              I am always excited to learn new technologies and push the
